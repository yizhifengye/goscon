...
## 特性
* 断线重连: [scp协议介绍](https://github.com/yizhifengye/goscon/blob/master/protocol.md)
...
配置选项含义，请参考[config.go](https://github.com/yizhifengye/goscon/blob/master/config.go)
